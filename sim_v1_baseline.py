...
os.makedirs("results_v1", exist_ok=True)
...
class MaritimeSim:
    ...
    def render(self, run_id, step):
        ...
        plt.savefig(f"results_v1/run_{run_id}_step_{step}.png")
        plt.close()
...
def get_coast_guard_move(defender, intruder, client):
    ...
    """
    system_prompt = """You are a highly logical Coast Guard captain.
...
if __name__ == "__main__":
    ...
    # Open log file
    with open("results_v1/simulation_logs.txt", "w") as log_file:
        ...
        # --- Final V1 Summary ---
        summary_msg = f"\n================================\n"
        summary_msg += f"FINAL V1 RESULTS: {successful_interceptions}/{total_runs} Interceptions\n"
        summary_msg += f"SUCCESS RATE V1: {(successful_interceptions/total_runs)*100}%\n"
        summary_msg += f"================================\n"
